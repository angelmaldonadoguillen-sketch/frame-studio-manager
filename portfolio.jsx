...
// Miniaturas de cada módulo y variante, dibujadas en 120×80. Cada módulo tiene su propia
// silueta para que se reconozca de un vistazo en el selector y en Composición.
// [tipo, x, y, ancho, alto, radio]: ink = títulos, fill = texto e imágenes, accent = acción,
// card = tarjeta con borde, faint = resto de la página, play = triángulo de video.
const FP_THUMBS={
  text:{simple:[['ink',12,16,56,6],['fill',12,30,96,3],['fill',12,37,90,3],['fill',12,44,94,3],['fill',12,51,62,3]],
    columns:[['ink',12,16,56,6],['fill',12,30,44,3],['fill',12,37,44,3],['fill',12,44,40,3],['fill',12,51,30,3],['fill',64,30,44,3],['fill',64,37,44,3],['fill',64,44,34,3],['fill',64,51,40,3]],
    quote:[['accent',12,22,2,36,0],['ink',20,24,80,5],['ink',20,33,86,5],['ink',20,42,60,5],['fill',20,54,30,3]]},
  gallery:{grid:[['ink',12,12,44,5],['fill',12,24,30,20,2],['accent',45,24,30,20,2],['fill',78,24,30,20,2],['accent',12,48,30,20,2],['fill',45,48,30,20,2],['fill',78,48,30,20,2]],
    mosaic:[['ink',12,12,44,5],['fill',12,24,96,26,2],['accent',12,53,30,16,2],['fill',45,53,30,16,2],['fill',78,53,30,16,2]],
    carousel:[['ink',12,12,44,5],['fill',12,24,70,40,2],['accent',86,24,40,40,2],['card',92,68,7,7,3.5],['card',101,68,7,7,3.5]]},
  prices:{cards:[['ink',12,10,44,5],['card',12,22,30,50,2],['card',45,22,30,50,2],['card',78,22,30,50,2],['ink',16,32,16,5],['ink',49,32,16,5],['ink',82,32,16,5],['fill',16,43,20,2],['fill',49,43,20,2],['fill',82,43,20,2],['fill',16,48,18,2],['fill',49,48,18,2],['fill',82,48,18,2],['accent',16,62,14,3],['accent',49,62,14,3],['accent',82,62,14,3]],
    list:[['ink',12,10,44,5],['fill',12,22,96,.8,0],['fill',12,26,34,3],['fill',56,26,24,2],['ink',90,25,18,5],['fill',12,42,96,.8,0],['fill',12,46,34,3],['fill',56,46,24,2],['ink',90,45,18,5],['fill',12,62,96,.8,0],['fill',12,66,34,3],['fill',56,66,24,2],['ink',90,65,18,5]],
    table:[['ink',12,10,44,5],['card',12,22,96,50,2],['fill',44,22,.8,50,0],['fill',76,22,.8,50,0],['ink',16,30,18,5],['ink',48,30,18,5],['ink',80,30,18,5],['fill',16,42,22,.8,0],['fill',48,42,22,.8,0],['fill',80,42,22,.8,0],['fill',16,49,22,.8,0],['fill',48,49,22,.8,0],['fill',80,49,22,.8,0],['accent',16,61,14,3],['accent',48,61,14,3],['accent',80,61,14,3]]},
  video:{wide:[['ink',12,10,44,5],['fill',12,21,96,50,2],['play',60,46]],
    vertical:[['ink',38,8,44,4],['fill',46,16,28,56,2],['play',60,44]],
    'with-text':[['ink',12,12,44,5],['fill',12,24,56,40,2],['play',40,44],['ink',76,34,28,4],['fill',76,42,32,2.5],['fill',76,48,26,2.5]]},
  'image-text':{left:[['ink',12,10,50,5],['fill',12,22,52,46,2],['ink',72,34,30,4],['fill',72,42,36,2.5],['fill',72,48,30,2.5],['fill',72,54,34,2.5]],
    right:[['ink',12,10,50,5],['fill',56,22,52,46,2],['ink',12,34,30,4],['fill',12,42,36,2.5],['fill',12,48,30,2.5],['fill',12,54,34,2.5]]},
  services:{cards:[['ink',12,10,44,5],['card',12,22,30,48,2],['card',45,22,30,48,2],['card',78,22,30,48,2],['accent',16,27,8,8,2],['accent',49,27,8,8,2],['accent',82,27,8,8,2],['ink',16,40,18,3.5],['ink',49,40,18,3.5],['ink',82,40,18,3.5],['fill',16,47,22,2],['fill',49,47,22,2],['fill',82,47,22,2],['fill',16,52,18,2],['fill',49,52,18,2],['fill',82,52,18,2]],
    list:[['ink',12,10,44,5],['fill',12,21,96,.8,0],['accent',12,25,10,10,2],['ink',28,26,30,3.5],['fill',28,32,56,2],['fill',12,41,96,.8,0],['accent',12,45,10,10,2],['ink',28,46,30,3.5],['fill',28,52,56,2],['fill',12,61,96,.8,0],['accent',12,65,10,10,2],['ink',28,66,30,3.5],['fill',28,72,56,2]]},
  contact:{banner:[['card',12,16,96,48,4],['ink',20,26,40,6],['fill',20,37,34,3],['fill',20,43,28,3],['fill',66,28,34,.8,0],['fill',66,33,20,2.5],['accent',66,40,18,3],['fill',66,48,34,.8,0]],
    links:[['ink',12,16,50,6],['fill',12,27,70,3],['fill',12,44,26,2.5],['accent',12,50,20,2],['fill',46,44,26,2.5],['accent',46,50,20,2],['fill',80,44,26,2.5],['accent',80,50,20,2]]},
  hero:{center:[['ink',30,20,60,8,1.5],['ink',38,31,44,8,1.5],['fill',28,46,64,3],['fill',36,53,48,3],['accent',50,61,20,6,3]],
    split:[['ink',12,24,46,7,1.5],['ink',12,34,34,7,1.5],['fill',12,47,44,3],['fill',12,53,36,3],['accent',12,61,18,5,2.5],['fill',66,14,42,52,2]]},
  navigation:{left:[['ink',12,16,30,6],['fill',70,18,10,2.5],['fill',84,18,10,2.5],['fill',98,18,10,2.5],['fill',0,30,120,.8,0],['faint',12,42,70,4],['faint',12,50,96,3],['faint',12,56,80,3]],
    center:[['ink',45,12,30,6],['fill',38,24,12,2.5],['fill',54,24,12,2.5],['fill',70,24,12,2.5],['fill',0,32,120,.8,0],['faint',12,44,96,3],['faint',12,50,80,3]]},
  footer:{simple:[['faint',12,12,96,3],['faint',12,18,80,3],['faint',12,24,88,3],['fill',0,50,120,.8,0],['ink',12,59,24,4],['fill',62,60,12,2.5],['fill',78,60,12,2.5],['fill',94,60,14,2.5]],
    columns:[['faint',12,10,96,3],['faint',12,16,80,3],['fill',0,28,120,.8,0],['ink',12,36,26,4],['ink',12,50,18,3],['fill',12,56,22,2],['fill',12,61,18,2],['ink',48,50,18,3],['fill',48,56,22,2],['fill',48,61,18,2],['ink',84,50,18,3],['fill',84,56,22,2],['fill',84,61,18,2]]}
};
const FPThumb=({type,variant})=>{const shapes=FP_THUMBS[type]?.[variant]||FP_THUMBS.text.simple;return <svg className={'fp-thumb fp-thumb-'+type+' fp-thumb-'+variant} viewBox="0 0 120 80" aria-hidden="true" focusable="false">{shapes.map((s,n)=>s[0]==='play'?<path key={n} className="fp-t-ink" d={'M'+(s[1]-3)+' '+(s[2]-4)+'l7 4-7 4z'}/>:<rect key={n} className={'fp-t-'+s[0]} x={s[1]} y={s[2]} width={s[3]} height={s[4]} rx={s[5]??1}/>)}</svg>;};
// Enlaces: correo y teléfono con su propio ícono; el de «sitio externo» solo para la web
const fpLinkIcon=link=>/^mailto:/i.test(link||'')?'mail':/^tel:/i.test(link||'')?'phone':'external';
...
const PortfolioEditor=({userId,workspaceId:legacyWorkspaceId,onExit,localPreview=false,initialDraft,canPublish=true,profileName=''})=>{
  ...
  const controls=section?FramePortfolio.designControls(section.type,section.variant):{};
        ...
        {section?<>
          ...
          <div className="fp-inspector-scroll" key={(itemId||selected)+':'+tab}>
            {item?<>
              ...
              {controls.columns&&<FPField label="Columnas en escritorio"><div className="fp-segmented">{[1,2,3,4].map(n=><button key={n} aria-label={n+' columnas'} aria-pressed={(section.design?.columns||3)===n} onClick={()=>updateDesign({columns:n})}>{n}</button>)}</div></FPField>}
              {controls.radius&&<FPField label="Esquinas"><div className="fp-segmented">{[[0,'Rectas'],[8,'Suaves'],[16,'Redondas']].map(([value,label])=><button key={value} aria-pressed={(section.design?.imageRadius??controls.radiusDefault)===value} onClick={()=>updateDesign({imageRadius:value})}>{label}</button>)}</div></FPField>}
              {controls.ratio&&<><h3 className="fp-group-title">Imágenes</h3><FPField label="Relación de aspecto"><select aria-label="Relación de aspecto" value={section.design?.imageRatio||'landscape'} onChange={e=>updateDesign({imageRatio:e.target.value})}><option value="original">Original · sin recorte</option><option value="wide">Panorámica · 16:9</option><option value="landscape">Horizontal · 4:3</option><option value="square">Cuadrada · 1:1</option><option value="social">Retrato · 4:5</option><option value="portrait">Vertical · 3:4</option><option value="story">Historia · 9:16</option></select></FPField></>}
              {controls.motion&&<div className="fp-motion-settings"><h3 className="fp-group-title">Animación de entrada</h3><FPField label="Efecto"><select aria-label="Efecto de animación" value={section.design?.animation||'none'} onChange={e=>updateDesign({animation:e.target.value})}><option value="none">Sin animación</option>{FramePortfolio.motionOptions(section.type).map(effect=><option key={effect} value={effect}>{{fade:'Aparecer suavemente',rise:'Subir suavemente',zoom:'Acercamiento sutil',stagger:'Bloques en secuencia'}[effect]}</option>)}</select></FPField>{section.design?.animation&&section.design.animation!=='none'&&<><FPSegmented label="Velocidad" value={section.design.motionSpeed||'smooth'} options={[['quick','Rápida'],['smooth','Suave'],['slow','Pausada']]} onChange={motionSpeed=>updateDesign({motionSpeed})}/><FPButton icon="play" disabled={reducedMotion} onClick={()=>{document.getElementById('fp-section-'+selected)?.scrollIntoView({block:'start',behavior:'auto'});setMotionReplay(r=>({id:selected,token:r.token+1}));}}>Probar animación</FPButton></>}{reducedMotion&&<p className="fp-help">Reducir movimiento está activado en este dispositivo.</p>}</div>}
            </>:<>
...
const PortfolioModule=({section:s,brandDraft,mobile,editing=false,selectedItem,onSelectItem,active=false,onFocusText,onEditText,replayToken=0,loadingMode='progressive'})=>{
  ...
  // La navegación se alinea con su composición; el resto, con lo elegido
  const align=s.type==='navigation'?(s.variant==='center'?'center':'left'):s.design?.align||(s.variant==='center'?'center':'left'),space={compact:.5,airy:1.6}[s.design?.spacing];
  // Sólo se honra lo que el panel ofrece: las barras de la página no cambian de tamaño.
  const size=!['navigation','footer'].includes(s.type)&&['small','large'].includes(s.design?.size)?s.design.size:undefined;
  const tone=['soft','contrast'].includes(s.design?.tone)?s.design.tone:undefined,carousel=!editing&&s.variant==='carousel'&&s.content.items.length>1;
  const itemsRef=React.useRef(null),[ends,setEnds]=React.useState({start:true,end:false});
  const measureEnds=()=>{const el=itemsRef.current;if(el)setEnds({start:el.scrollLeft<=2,end:el.scrollLeft+el.clientWidth>=el.scrollWidth-2});};
  React.useEffect(()=>{if(carousel)measureEnds();},[carousel,s.content.items.length]);
  const slide=dir=>{const el=itemsRef.current,item=el?.querySelector('.fp-site-item');if(item)el.scrollBy({left:dir*(item.getBoundingClientRect().width+parseFloat(getComputedStyle(el).columnGap||0)),behavior:window.matchMedia('(prefers-reduced-motion: reduce)').matches?'auto':'smooth'});};
  return <Tag aria-label={s.type==='navigation'?(s.content.title||'Navegación del portfolio'):undefined} data-module={s.type} data-variant={s.variant} data-align={align} data-tone={tone} data-size={size} data-has-items={s.content.items.length>0} data-loading-mode={editing?'editor':loadingMode} ref={motionRef} className={'fp-site-section fp-site-'+s.type+' fp-variant-'+s.variant+(mobile?' fp-site-narrow':'')} style={{'--fp-columns':s.design?.columns,'--fp-image-ratio':{original:'auto',wide:'16/9',landscape:'4/3',square:'1',social:'4/5',portrait:'3/4',story:'9/16'}[s.design?.imageRatio],'--fp-image-radius':s.design?.imageRadius===undefined?undefined:s.design.imageRadius+'px','--fp-space':space,textAlign:align}}>
    ...
    {!!s.content.items.length&&<div className="fp-site-items" ref={itemsRef} onScroll={carousel?measureEnds:undefined} role={!editing&&s.variant==='carousel'?'region':undefined} aria-label={!editing&&s.variant==='carousel'?'Galería desplazable':undefined} tabIndex={!editing&&s.variant==='carousel'?0:undefined}>{s.content.items.map(i=><div key={i.id} className={'fp-site-item'+(i.featured?' fp-featured':'')} data-selected={editing&&selectedItem===i.id} role={editing?'button':undefined} tabIndex={editing?0:undefined} aria-label={editing?'Editar bloque '+(i.title||'sin título'):undefined} onClick={editing?e=>{e.stopPropagation();onSelectItem?.(i.id);}:undefined} onKeyDown={editing?e=>{if(e.target===e.currentTarget&&['Enter',' '].includes(e.key)){e.preventDefault();e.stopPropagation();onSelectItem?.(i.id);}}:undefined}>
      ...
      {FramePortfolio.safeLink(i.link)&&(editing?<span className="fp-site-link">{s.type==='prices'?'Solicitar cotización':i.title||'Ver más'} <FPIcon name={fpLinkIcon(i.link)} size={14}/></span>:<a className="fp-site-link" href={FramePortfolio.safeLink(i.link)} target={/^https?:/i.test(i.link)?'_blank':undefined} rel="noopener noreferrer">{s.type==='prices'?'Solicitar cotización':i.title||'Ver más'} <FPIcon name={fpLinkIcon(i.link)} size={14}/></a>)}</div>
    </div>)}</div>}
    {carousel&&<div className="fp-carousel-nav"><button type="button" aria-label="Anterior" disabled={ends.start} onClick={()=>slide(-1)}><FPIcon name="back" size={18}/></button><button type="button" aria-label="Siguiente" disabled={ends.end} onClick={()=>slide(1)}><FPIcon name="forward" size={18}/></button></div>}
  </Tag>;
};
